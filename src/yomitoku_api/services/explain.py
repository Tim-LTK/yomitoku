"""Generation layer — targeted element explanations (Phase 1.5 UX)."""
...
def generate_element_explanation(settings: Settings, bundle: PromptBundle) -> RawOutput:
    """Claude emits `ExplainEnvelope` JSON."""
    ...
    logger.info(
        "anthropic.generation.explain_element",
        extra={
            "model": settings.anthropic_model,
