"""Generation layer — onboarding learner profile synthesis from questionnaire answers."""
...
def generate_onboarding_assessment(settings: Settings, bundle: PromptBundle) -> RawOutput:
    """Claude emits `OnboardingAssessEnvelope` JSON without server timestamps."""
    ...
    logger.info(
        "anthropic.generation.onboard_assess",
        extra={
            "model": settings.anthropic_model,
